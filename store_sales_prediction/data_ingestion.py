...
create_table_sales = text('CREATE TABLE sales (ID VARCHAR(30), DATE DATETIME, STORE_NBR INTEGER, FAMILY VARCHAR(30), SALES FLOAT, ONPROMOTION INTEGER)')
create_table_stores = text('CREATE TABLE stores (STORE_NBR INTEGER, CITY VARCHAR(30), STATE VARCHAR(30), TYPE VARCHAR(3), CLUSTER INTEGER)')
create_table_transactions = text('CREATE TABLE transactions (DATE DATETIME, STORE_NBR INTEGER, TRANSACTIONS BIGINT)')
